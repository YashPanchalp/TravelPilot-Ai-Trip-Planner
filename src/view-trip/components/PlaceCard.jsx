...
function PlaceCard({place}) {
  ...
  return (
    ...
    <div className='group overflow-hidden rounded-xl border border-slate-200 bg-white shadow-[0_16px_40px_-22px_rgba(15,23,42,0.35)] transition-all duration-500 transform-gpu hover:-translate-y-1 hover:rotate-[0.25deg] hover:shadow-[0_24px_55px_-20px_rgba(79,70,229,0.35)] sm:rounded-2xl'>
        ...
        <div className='min-w-0 space-y-3 p-3.5 sm:p-4'>
            ...
            <div className='flex flex-wrap gap-2'>
              <h3 className='rounded-full border border-orange-200 bg-orange-50 px-3 py-1 text-xs font-semibold text-orange-700'>
                🚕 Travel: {place?.timeToTravel || 'N/A'}
              </h3>
              <h3 className='rounded-full border border-rose-200 bg-rose-50 px-3 py-1 text-xs font-semibold text-rose-700'>
                🎟️ Ticket: {formatInr(place?.ticketPricing)}
              </h3>
            </div>
            <button className='w-full rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 text-sm font-semibold text-slate-700 transition-colors duration-300 hover:bg-slate-100 sm:w-auto'>
